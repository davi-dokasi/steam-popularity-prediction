...
## Alguns pacotes eu desconheço ainda
def print_log(*args):
...
def get_all_app_id():
    ...
    while True:
        ...
        # A nova API retorna 50 mil por vez, então precisamos paginar
...
#####################
## AQUI QUE O PROGRAMA RODA DE VERDADE
#####################
...
def main():
    ...
    while len(apps_remaining_deque) > 0:
        ...
        if appdetails['success'] == False:
            ...
            time.sleep(1.5)  # Proteção contra Rate Limit inserida
            continue
        ...
        i += 1
        # Proteção contra perdas de dados: Salvando a cada 100 jogos (reduzido de 1000)
        if i >= 100:
        ...
        # Proteção contra Rate Limit inserida
        time.sleep(1.5)
